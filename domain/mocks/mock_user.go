...
import (
	...
	domain "github.com/HoangTheQuyen96/user-service/domain"
...
func (m *MockUserUsecase) Login(arg0 context.Context, arg1 *domain.LoginRequest) (*domain.LoginResponse, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserUsecase) Register(arg0 context.Context, arg1 *domain.CreateUserRequest) (*domain.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) GetUserByPhoneOrEmail(ctx context.Context, emailOrPhone string) (*domain.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUserByPhoneOrEmail", ctx, emailOrPhone)
	ret0, _ := ret[0].(*domain.User)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockUserRepositoryMockRecorder) GetUserByPhoneOrEmail(ctx, emailOrPhone interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUserByPhoneOrEmail", reflect.TypeOf((*MockUserRepository)(nil).GetUserByPhoneOrEmail), ctx, emailOrPhone)
}
